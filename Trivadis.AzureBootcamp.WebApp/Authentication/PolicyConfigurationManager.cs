...
namespace Trivadis.AzureBootcamp.WebApp.Authentication
{
    ...
    {
        private static readonly TimeSpan DefaultAutomaticRefreshInterval = new TimeSpan(5, 0, 0, 0);
        private static readonly TimeSpan DefaultRefreshInterval = new TimeSpan(0, 0, 0, 30);
        private static readonly TimeSpan MinimumAutomaticRefreshInterval = new TimeSpan(0, 0, 5, 0);
        private static readonly TimeSpan MinimumRefreshInterval = new TimeSpan(0, 0, 0, 1);
